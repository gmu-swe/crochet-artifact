    ...
    return {
        'no-check-no-sum-native' : {
            'cmd'  : run_bench.format(
                benchvm=jdk_vm,
                benchvmargs='',
                benchclass='--debug --debug-reps 1 net.jonbell.bench.NoCheckpointBench',
                ),
            'wrap' : '{}'.format(pin),
            'env'  : { },
            },
        ...
        'check-no-sum-serial' : {
            'cmd'  : run_bench.format(
                benchvm=jdk_vm,
                benchvmargs='',
                benchclass='--debug --debug-reps 1 net.jonbell.bench.CheckpointSerializationBench',
                ),
            'wrap' : '{}'.format(pin),
            'env'  : { },
            },
        ...
        'check-sum-cloner' : {
            'cmd'  : run_bench.format(
                benchvm=jdk_vm,
                benchvmargs='-Dchecksum',
                benchclass='--debug --debug-reps 1 net.jonbell.bench.DeepCloneBench',
                ),
            'wrap' : '{}'.format(pin),
            'env'  : { },
            },
        'check-sum-mapcloner' : {
            'cmd'  : run_bench.format(
                benchvm=jdk_vm,
                benchvmargs='-Dchecksum',
                benchclass='--debug --debug-reps 1 net.jonbell.bench.HashMapDeepCloneBench',
                ),
            'wrap' : '{}'.format(pin),
            'env'  : { },
            },
